...
var TableProps = _react2.default.createClass({
  ...
  render: function render() {
    return _react2.default.createElement(
      ...
      _react2.default.createElement(
        'td',
        { className: 'text-center innerFont rankFont' },
        this.props.rank
      ),
      _react2.default.createElement(
        'td',
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            ...
            _react2.default.createElement('img', { src: this.props.image, className: 'img-r' })
          )
        ),
        _react2.default.createElement(
          'a',
      ...
      _react2.default.createElement(
        ...
        _react2.default.createElement(
          'p',
          { className: 'innerFont text-center numberFont' },
          this.props.pointsM
        )
      ),
      _react2.default.createElement(
...
var btoa = window.btoa || __webpack_require__(127);
...
var _createLocation2 = __webpack_require__(157);
...
var _AllTimeComponent = __webpack_require__(135);

var _AllTimeComponent2 = _interopRequireDefault(_AllTimeComponent);

var _MonthComponent = __webpack_require__(136);

var _MonthComponent2 = _interopRequireDefault(_MonthComponent);

var _TableLayout = __webpack_require__(137);

var _TableLayout2 = _interopRequireDefault(_TableLayout);

var _TableProps = __webpack_require__(47);
...
_reactDom2.default.render(_react2.default.createElement(
  ...
  _react2.default.createElement(
    _reactRouter.Route,
    { path: '/', component: _TableLayout2.default },
    _react2.default.createElement(_reactRouter.IndexRoute, { component: _MonthComponent2.default }),
    _react2.default.createElement(_reactRouter.Route, { path: '/AllTimeLayout', component: _AllTimeComponent2.default })
  )
...
//Helper imports
var AllTimeComponent = _react2.default.createClass({
  displayName: 'AllTimeComponent',
  ...
  componentDidMount: function componentDidMount() {
    ...
    _axios2.default.get("https://fcctop100.herokuapp.com/api/fccusers/top/alltime").then(function (data) {
      _this.setState({
        users: data.data
      });
    });
  ...
  render: function render() {
    return _react2.default.createElement(
      ...
      _react2.default.createElement(
        ...
        _react2.default.createElement(
          'tr',
          { className: 'text-center outerFont' },
          _react2.default.createElement(
            'td',
            null,
            'Rank'
        ...
        this.state.users.map(function (user, j) {
          return _react2.default.createElement(_TableProps2.default, { key: user.username, image: user.img, rank: j + 1, name: user.username, pointsM: user.recent, pointsA: user.alltime });
        })
      )
    );
  }
...
exports.default = AllTimeComponent;
...
//Helper imports
//Main imports
var MonthComponent = _react2.default.createClass({
  displayName: 'MonthComponent',
  ...
  componentDidMount: function componentDidMount() {
    ...
    _axios2.default.get("https://fcctop100.herokuapp.com/api/fccusers/top/recent").then(function (data) {
      _this.setState({
        users: data.data
      });
    });
      ...
      _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            ...
            _react2.default.createElement(
              _reactRouter.Link,
              { className: 'linkColor', to: '/AllTimeLayout' },
              'All time Points'
            )
          )
        ),
        this.state.users.map(function (user, i) {
          return _react2.default.createElement(_TableProps2.default, { key: user.username, image: user.img, rank: i + 1, name: user.username, pointsM: user.recent, pointsA: user.alltime });
        })
      )
    );
  }
      ...
      _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            ...
            _react2.default.createElement(
              'th',
              { className: 'tableHeader text-center outerFont', colSpan: '4' },
...
var getNativeComponentFromComposite = __webpack_require__(116);
...
if (process.env.NODE_ENV !== 'production') {
  ...
  var ReactNativeOperationHistoryDevtool = __webpack_require__(222);
...
(function webpackMissingModule() { throw new Error("Cannot find module \"/Users/Nick/Documents/GitHub/FreeCodeCamp Projects/React Projects/FCCleaderboard/build\""); }());
